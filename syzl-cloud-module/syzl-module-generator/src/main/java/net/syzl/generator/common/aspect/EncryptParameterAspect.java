package net.syzl.generator.common.aspect;

import lombok.extern.slf4j.Slf4j;
import net.syzl.generator.common.annotation.EncryptParameter;
import net.syzl.generator.common.page.PageResult;
import net.syzl.generator.common.utils.EncryptUtils;
...
public class EncryptParameterAspect {
     ...
     * @throws Throwable
     */
    @Around("execution(* net.syzl.generator.controller.DataSourceController.*(..))")
    ...
    private void handleItem(Object item, boolean isDecrypt) {
        ...
        // 只处理在entity包下面的对象
        if (Objects.isNull(item.getClass().getPackage()) || !item.getClass().getPackage().getName().startsWith("net.syzl.generator.entity")) {
            return;
        }
