package net.syzl.exams.exam.controller;
...
import net.syzl.exams.core.api.dto.BaseStateReqDTO;
...
public class ExamController extends BaseController {
    ...
    */
     ...
     */
    @Operation(summary ="检测视角")
    @RequestMapping(value = "/onlineExam", method = { RequestMethod.POST})
    public ApiRest<List<ExamOnlineRespDTO>> online() {
        String userId= UserUtils.getUserId();
        //分页查询并转换
        List<ExamOnlineRespDTO> page = baseService.onlineExam(userId);
        return super.success(page);
    }
